                            ...
                            <form class="js-validation-register form-horizontal push-50-t push-50" action="register" method="post">
                                ...
                                <div class="form-group" >
                                    <div class="col-xs-12 col-sm-6 col-md-5">
                                        <button class="btn btn-block" type="submit" style="width:105%;position:absolute;margin-left:50%;background-color: #eb2c24;color: white"><i class="fa fa-plus pull-right"></i> Cr�er un compte</button>
                                    </div>
                                </div>
                            </form>
                            <!-- END Register Form -->
