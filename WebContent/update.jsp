...
<div class="content">
	<div class="row">
		<div class="col-sm-7">
			<h1 class="page-heading">Modifier Réclamation</h1>
		</div>
...
<div class="content content-boxed">
	...
	<!-- Main Content -->
	<form class="form-horizontal push-50-t push-50" action="update" method="post">
		<div class="block">
						...
						<div class="block-content block-content-narrow">
								...
								<div class="col-sm-9">
									<div class="form-material form-material-primary floating">
										<select class="form-control" id="material-select2"
											name="aero" size="1">
											<option value="${update.aeroport}">${update.aeroport}</option>
											<!-- Empty value for demostrating material select box -->
											<c:forEach var="list" items="${listaero}">
									...
									<div class="form-material form-material-primary floating">
										<select class="form-control" id="material-select2"
											...
											<option value="${serv}">${serv}</option>
												<c:forEach var="list" items="${ficheSes}">
								...
								<div class="col-sm-9">
									<div class="form-material form-material-primary floating">
										<input class="form-control" type="text"
											...
											name="nature"> <label for="material-color-primary2">Nature</label>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-xs-12">
									<div class="form-material form-material-primary floating">
										<textarea class="form-control" id="material-textarea-small2"
											name="cause" rows="3">${update.cause}</textarea>
							...
							<div class="form-group">
								<div class="col-xs-12">
									<div class="form-material form-material-primary floating">
										<textarea class="form-control" id="material-textarea-small2"
											name="action" rows="3">${update.action}</textarea>
								...
								<div class="col-sm-12">
									<div class="form-material form-material-primary floating">
										<textarea class="form-control" id="material-textarea-large2"
										 name="efficacite" rows="8">${update.mesEfficacite}</textarea>
								...
								<div class="col-sm-9">
									<div class="form-material form-material-primary floating">
										<select class="form-control" id="material-select2"
											...
											<option value="${update.processus}">${update.processus}</option>
											<!-- Empty value for demostrating material select box -->
								...
								<div class="col-sm-9">
									<div class="form-material form-material-primary floating">
										<input class="form-control" type="text"
											...
											name="resp"> <label for="material-color-primary2">Responsable</label>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-9">
									<div class="form-material form-material-primary floating">
										<select class="form-control" id="material-select2"
											...
											<option value="${update.consequence }">${update.consequence }</option>
											
											<c:forEach var="list" items="${listCon}">
											<option value="${list}">${list}</option>
											</c:forEach>

										</select> <label for="material-color-primary2">Conséquence</label>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-xs-12">
									<div class="form-material form-material-primary floating">
										<textarea class="form-control" id="material-textarea-small2"
										 name="solution" rows="3">${update.solution}</textarea>
								...
								<div class="col-xs-12">
									<div class="form-material form-material-primary floating">
										<textarea class="form-control" name="echeance"
											...
											rows="3">${update.echeance}</textarea>
